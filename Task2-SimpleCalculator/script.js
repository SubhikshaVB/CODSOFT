...
const unitConverterButton = document.querySelector('.btn[data-key="unit-converter"]');
unitConverterButton.addEventListener('click', () => {
    window.location.href = 'unit_converter.html';
});

const scientificCalculatorButton = document.querySelector('.btn[data-key="scientific-calculator"]');
scientificCalculatorButton.addEventListener('click', () => {
    window.location.href = 'scientific_calculator.html';
});
